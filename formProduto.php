...
<div class="container mt-5">
    ...
    <form class="g-3" action="<?= $_GET['acao'] ?>Produto.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-9">
                <label for="produtocategoria_id" class="form-label">Descrição</label>
                <input type="text"
                    class="form-control"
                    id="produtocategoria_id"
                    name="produtocategoria_id"
                    placeholder="Descricao"
                    required
                    autofocus
                    value="<?= Funcoes::setValue($dados, 'produtocategoria_id') ?>">
            </div>
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" name="caracteristicas" id="caracteristicas">
                    <?= Funcoes::setValue($dados, 'produtocategoria_id') ?></textarea>
            </div>
