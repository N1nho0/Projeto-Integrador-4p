...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        <div class="col-2 text-end">
            <a href="index.php?pagina=fornecedorMenu" class="btn btn-outline-secondary btn-sm">
                Voltar
            </a>
        </div>
    </div>

    <!-- Alteração aqui, redirecionando para o fornecedor -->
    <form class="g-3" action="<?= $_GET['acao'] ?>Fornecedor.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <select name="fornecedorId" id="fornecedorId" class="form-control" required>
                    ...
                    $aFornecedor = $db->dbSelect("SELECT * FROM fornecedor WHERE id = $idFornecedor");
        ...
        <div class="row mt-3">
            <div class="col-12">
                <a href="index.php?pagina=fornecedorMenu" class="btn btn-outline-secondary btn-sm">Voltar</a>
